...
const Scene = ({ ...props }) => {
  ...
  const { nodes, materials } = useSpline('https://prod.spline.design/Ixlk9z4kVhTP8VIa/scene.splinecode')
  return (
    <Canvas>
      <group {...props} dispose={null}>
        <OrthographicCamera
          ...
          scale={1}
        />
        <motion.group name="Drawers" animate={{rotateX: isRotated ? -Math.PI/2 : 0, y: isRotated ? 200 : 0}} transition={{type:"spring", bounce: 0.15}}>
        <mesh
          ref={mesh}
          name="Boolean"
        ...
        <group name="Group Clones" position={[0, 83, -12.52]}>
          <motion.group name="Clone 0" onClick={() => openDrawer(0)} animate={{z: isOpen(0) ? zOpen : 0}} transition={drawerTransition} whileHover={{scale: 1.01}}>
          ...
          <motion.group name="Clone 1" position={[0, -85, 0]} onClick={() => openDrawer(1)} animate={{z: isOpen(1) ? zOpen : 0}} transition={drawerTransition} whileHover={{scale: 1.01}}>
          ...
          <motion.group name="Clone 2" position={[0, -170, 0]} onClick={() => openDrawer(2)} animate={{z: isOpen(2) ? zOpen : 0}} transition={drawerTransition} whileHover={{scale: 1.01}}>
        ...
        <hemisphereLight name="Default Ambient Light" intensity={.3} color="#9c2e0c" />
      </group>
    </Canvas>
  )
}
